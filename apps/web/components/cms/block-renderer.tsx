...
export function BlockRenderer({ blocks = [], locale, pageTitle, pageSlug }: { blocks?: CmsBlock[]; locale: SiteLocale; pageTitle?: string; pageSlug?: string }) {
  return (
    <>
      {blocks.map((block, index) => {
        switch (block.__component) {
          ...
          case 'page.deliverables-home':
            return <DeliverablesHomeBlockView key={blockKey(block, index)} block={block} locale={locale} />
          case 'page.why-home':
            return <WhyHomeBlockView key={blockKey(block, index)} block={block} locale={locale} />
          case 'page.audience-home':
            return <AudienceHomeBlockView key={blockKey(block, index)} block={block} locale={locale} />
          case 'page.concepts-home':
            return <ConceptsHomeBlockView key={blockKey(block, index)} block={block} locale={locale} />
          case 'page.method-home':
            return <MethodHomeBlockView key={blockKey(block, index)} block={block} locale={locale} />
          case 'page.pricing-home':
            return <PricingHomeBlockView key={blockKey(block, index)} block={block} locale={locale} />
          case 'page.proposal-home':
            return <ProposalHomeBlockView key={blockKey(block, index)} block={block} locale={locale} />
          case 'page.sample-preview-home':
            return <SamplePreviewHomeBlockView key={blockKey(block, index)} block={block} locale={locale} />
          ...
          case 'page.final-cta-home':
            return <FinalCtaHomeBlockView key={blockKey(block, index)} block={block} locale={locale} />
          case 'page.hero':
          ...
          case 'page.form-section':
            return <FormSectionBlockView key={blockKey(block, index)} block={block} locale={locale} pageTitle={pageTitle} pageSlug={pageSlug} />
          default:
            return null
        }
      })}
